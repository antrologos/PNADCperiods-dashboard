...
load_app_data <- function() {
  ...
  qinc_path        <- file.path(data_dir, "quarterly_income_data.rds")
  qinc_shares_path <- file.path(data_dir, "quarterly_income_shares_data.rds")
  qinc_lorenz_path <- file.path(data_dir, "quarterly_lorenz_data.rds")
  ...
  app_data$get_quarterly_income_data        <- make_lazy_loader(qinc_path)
  app_data$get_quarterly_income_shares_data <- make_lazy_loader(qinc_shares_path)
  app_data$get_quarterly_lorenz_data        <- make_lazy_loader(qinc_lorenz_path)
  ineq_existing <- c(ineq_path, shares_path, lorenz_path, decomp_path,
                      qinc_path, qinc_shares_path, qinc_lorenz_path)
